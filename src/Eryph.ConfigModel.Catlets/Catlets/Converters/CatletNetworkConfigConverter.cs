...
{
    public class List() : DictionaryToListConverter<CatletNetworkConfig[], CatletConfig>(nameof(CatletConfig.Networks));
        ...
        IConverterContext<CatletConfig> context, IDictionary<object, object> dictionary, object? data = default)
    {
        return new CatletNetworkConfig
        {
            ...
            Mutation = GetEnumProperty<MutationType>(dictionary, nameof(CatletNetworkConfig.Mutation))
        };
    }
}
